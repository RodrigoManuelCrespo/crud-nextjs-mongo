...
export default function Tasks() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-xl mb-5">Tareas</h1>
            {tasks.map((task: TaskModel) => {
                return (
                    <Card className="border-none bg-background/60 dark:bg-default-100/50 w-full mb-4"
                        key={task._id}>
                        ...
                        <CardFooter className="justify-center gap-5">
                            ...
                            <Button isIconOnly color="primary" variant="flat" onPress={() => handleOpenModal(task)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                </svg>
                            </Button>
                            <Button isIconOnly color="primary" variant="flat" onPress={() => handleDeleteRequest(task._id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
